...
echo [ begin aegis v1.15 %date% %time% ] >"%~dp0aegis.log" 2>&1
echo. >>"%~dp0aegis.log" 2>&1
echo.
echo.
echo -/- aegis v1.15 by https://voat.co/u/thepower
...
:main
   ...
   echo. >>"%~dp0aegis.log" 2>&1
   echo [ end aegis v1.15 %date% %time% ] >>"%~dp0aegis.log" 2>&1
...
:rpoint
   wmic.exe /namespace:\\root\default path systemrestore call createrestorepoint "aegis v1.15", 100, 12 >>"%~dp0aegis.log" 2>&1
