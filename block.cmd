...
findstr 23.32.137.63 routes.tmp >nul 2>&1
if %errorlevel% neq 0 (
  route -p add 23.32.137.63/32 0.0.0.0 >nul 2>&1
  echo blocked 23.32.137.63
)
...
findstr 64.4.54.99 routes.tmp >nul 2>&1
if %errorlevel% neq 0 (
  route -p add 64.4.54.99/32 0.0.0.0 >nul 2>&1
  echo blocked 64.4.54.99
)
...
findstr 65.52.108.29 routes.tmp >nul 2>&1
if %errorlevel% neq 0 (
  route -p add 65.52.108.29/32 0.0.0.0 >nul 2>&1
  echo blocked 65.52.108.29
)
...
findstr 65.52.108.136 routes.tmp >nul 2>&1
if %errorlevel% neq 0 (
  route -p add 65.52.108.136/32 0.0.0.0 >nul 2>&1
  echo blocked 65.52.108.136
)
...
findstr 65.55.57.27 routes.tmp >nul 2>&1
if %errorlevel% neq 0 (
  route -p add 65.55.57.27/32 0.0.0.0 >nul 2>&1
  echo blocked 65.55.57.27
)
...
findstr 68.67.152.90 routes.tmp >nul 2>&1
if %errorlevel% neq 0 (
  route -p add 68.67.152.90/32 0.0.0.0 >nul 2>&1
  echo blocked 68.67.152.90
)
...
findstr 68.67.176.40 routes.tmp >nul 2>&1
if %errorlevel% neq 0 (
  route -p add 68.67.176.40/32 0.0.0.0 >nul 2>&1
  echo blocked 68.67.176.40
)
...
findstr 72.246.56.34 routes.tmp >nul 2>&1
if %errorlevel% neq 0 (
  route -p add 72.246.56.34/32 0.0.0.0 >nul 2>&1
  echo blocked 72.246.56.34
)
...
findstr 72.246.56.72 routes.tmp >nul 2>&1
if %errorlevel% neq 0 (
  route -p add 72.246.56.72/32 0.0.0.0 >nul 2>&1
  echo blocked 72.246.56.72
)
findstr 72.247.139.242 routes.tmp >nul 2>&1
if %errorlevel% neq 0 (
  route -p add 72.247.139.242/32 0.0.0.0 >nul 2>&1
  echo blocked 72.247.139.242
)
...
findstr 96.6.57.18 routes.tmp >nul 2>&1
if %errorlevel% neq 0 (
  route -p add 96.6.57.18/32 0.0.0.0 >nul 2>&1
  echo blocked 96.6.57.18
)
findstr 96.6.61.146 routes.tmp >nul 2>&1
if %errorlevel% neq 0 (
  route -p add 96.6.61.146/32 0.0.0.0 >nul 2>&1
  echo blocked 96.6.61.146
)
...
findstr 104.90.64.93 routes.tmp >nul 2>&1
if %errorlevel% neq 0 (
  route -p add 104.90.64.93/32 0.0.0.0 >nul 2>&1
  echo blocked 104.90.64.93
)
findstr 104.90.75.122 routes.tmp >nul 2>&1
if %errorlevel% neq 0 (
  route -p add 104.90.75.122/32 0.0.0.0 >nul 2>&1
  echo blocked 104.90.75.122
)
findstr 104.90.89.185 routes.tmp >nul 2>&1
if %errorlevel% neq 0 (
  route -p add 104.90.89.185/32 0.0.0.0 >nul 2>&1
  echo blocked 104.90.89.185
)
findstr 104.90.92.235 routes.tmp >nul 2>&1
if %errorlevel% neq 0 (
  route -p add 104.90.92.235/32 0.0.0.0 >nul 2>&1
  echo blocked 104.90.92.235
)
findstr 104.93.174.145 routes.tmp >nul 2>&1
if %errorlevel% neq 0 (
  route -p add 104.93.174.145/32 0.0.0.0 >nul 2>&1
  echo blocked 104.93.174.145
)
findstr 104.93.176.29 routes.tmp >nul 2>&1
if %errorlevel% neq 0 (
  route -p add 104.93.176.29/32 0.0.0.0 >nul 2>&1
  echo blocked 104.93.176.29
)
findstr 104.93.196.53 routes.tmp >nul 2>&1
if %errorlevel% neq 0 (
  route -p add 104.93.196.53/32 0.0.0.0 >nul 2>&1
  echo blocked 104.93.196.53
)
...
findstr 131.253.40.122 routes.tmp >nul 2>&1
if %errorlevel% neq 0 (
  route -p add 131.253.40.122/32 0.0.0.0 >nul 2>&1
  echo blocked 131.253.40.122
)
...
findstr 134.170.58.190 routes.tmp >nul 2>&1
if %errorlevel% neq 0 (
  route -p add 134.170.58.190/32 0.0.0.0 >nul 2>&1
  echo blocked 134.170.58.190
)
...
findstr 134.170.120.200 routes.tmp >nul 2>&1
if %errorlevel% neq 0 (
  route -p add 134.170.120.200/32 0.0.0.0 >nul 2>&1
  echo blocked 134.170.120.200
)
...
findstr 157.55.133.204 routes.tmp >nul 2>&1
if %errorlevel% neq 0 (
  route -p add 157.55.133.204/32 0.0.0.0 >nul 2>&1
  echo blocked 157.55.133.204
)
...
findstr 157.56.64.122 routes.tmp >nul 2>&1
if %errorlevel% neq 0 (
  route -p add 157.56.64.122/32 0.0.0.0 >nul 2>&1
  echo blocked 157.56.64.122
)
...
findstr 157.56.106.184 routes.tmp >nul 2>&1
if %errorlevel% neq 0 (
  route -p add 157.56.106.184/32 0.0.0.0 >nul 2>&1
  echo blocked 157.56.106.184
)
...
findstr 173.205.27.211 routes.tmp >nul 2>&1
if %errorlevel% neq 0 (
  route -p add 173.205.27.211/32 0.0.0.0 >nul 2>&1
  echo blocked 173.205.27.211
)
findstr 173.205.27.227 routes.tmp >nul 2>&1
if %errorlevel% neq 0 (
  route -p add 173.205.27.227/32 0.0.0.0 >nul 2>&1
  echo blocked 173.205.27.227
)
...
findstr 207.46.11.151 routes.tmp >nul 2>&1
if %errorlevel% neq 0 (
  route -p add 207.46.11.151/32 0.0.0.0 >nul 2>&1
  echo blocked 207.46.11.151
)
findstr 207.46.101.29 routes.tmp >nul 2>&1
if %errorlevel% neq 0 (
  route -p add 207.46.101.29/32 0.0.0.0 >nul 2>&1
  echo blocked 207.46.101.29
)
...
findstr 216.38.160.128 routes.tmp >nul 2>&1
if %errorlevel% neq 0 (
  route -p add 216.38.160.128/32 0.0.0.0 >nul 2>&1
  echo blocked 216.38.160.128
)
